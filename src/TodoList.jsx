...
const TodoList = () => {
  ...
  const [date, setDate] = useState("");   // yyyy-mm-dd format (internal)
  ...
  const formatDate = (dateStr) => {
    if (!dateStr || dateStr === "No Date") return "dd-mm-yyyy";
    ...
    <div className="todo-container">
      ...
      <div className="controls">
        ...
        <div className="date-wrapper">
          ...
          />
          <span className="date-placeholder">{formatDate(date)}</span>
        </div>
      </div>
